							...
							<div className='flex flex-col justify-start items-start self-stretch  relative'>
								...
								<div className='flex flex-col justify-start items-start self-stretch  gap-3 py-4 bg-white'>
									<div className='flex justify-start items-center self-stretch  relative gap-2'>
										...
										/>
										<p className='md:md:w-[645px] text-base text-left text-[#0f0e0e]'>
											[필수] 개인정보 수집 및 이용에 대한
											동의
										</p>
										<ButtonAgreement value='내용보기' />
						...
						content={
							<p className='md:w-[604px] text-xs text-left text-black'>
								...
								<span className='md:w-[604px] text-xs text-left text-black'>
									&quot;사이버몰&quot;이란 회사가 재화 또는
									용역(이하 &quot;재화 등&quot;)을 이용자에게
									제공하기 위하여 컴퓨터 등 정보통신 설비를
									이용하여 재화 등을 거래할 수 있도록 설정한
									가상의 영업장을 말하며, 아울러 사이버 몰을
									운영하는 사업자의 의미로도 사용합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									&quot;이용자&quot;란 사이버몰에 접속하여 이
									약관에 따라 회사가 제공하는 서비스를 받는
									회원 및 비회원을 말합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									&quot;회원&quot;이라 함은 회사에 개인정보를
									제공하여 회원 등록을 한 자로서, 회사의
									정보를 지속적으로 제공 받으며, 회사가
									제공하는 서비스를 계속적으로 이용할 수 있는
									자를 말합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									&quot;비회원&quot;이라 함은 회원에 가입하지
									않고 회사가 제공하는 서비스를 이용하는 자를
									말합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									이외에 이 약관에서 사용하는 용어의 정의는
									관계 법령 및 서비스 별 안내에서 정하는 바에
									의합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									주소를 포함), 전화번호, 모사전송번호,
									이메일주소, 사업자등록번호,
									통신판매업신고번호, 개인정보관리책임자 등을
									이용자가 쉽게 알 수 있도록 사이버몰의 초기
									서비스화면(전면)에 게시합니다. 다만, 약관의
									내용은 이용자가 연결화면을 통하여 볼 수
									있도록 할 수 있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									법률』, 『전자상거래 등에서의 소비자보호에
									관한 법률』, 『소비자기본법』 등 관련법을
									위배하지 않는 범위 에서 이 약관을 개정할 수
									있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 약관을 개정할 경우에는 적용일자 및
									개정사유를 명시하여 현행약관과 회사의 화면에
									그 적용일자 7일 이전부터 적용일자 전일까지
									공지합니다. 다만, 이용자에게 불리하게
									약관내용을 변경하는 경우에는 최소한 30일
									이상의 사전 유예기간을 두고 공지합니다. 이
									경우 회사는 개정전 내용과 개정후 내용을
									명확하게 비교하여 이용자가 알기 쉽도록
									표시합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사가 약관을 개정할 경우에는 그 개정약관은
									그 적용일자 이후에 체결되는 계약에만
									적용되고 그 이전에 이미 체결된 계약에
									대해서는 개정 전의 약관조항이 그대로
									적용됩니다. 다만 이미 계약을 체결한 이용자가
									개정약관 조항의 적용을 받기를 원하는 뜻을
									제4항에 의한 개정약관의 공지기간 내에 회사에
									송신하여 회사의 동의를 받은 경우에는
									개정약관 조항이 적용됩니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									해석에 관하여는 『전자상거래 등에서의
									소비자보호에 관한 법률』, 『약관의 규제에
									관한 법률』, 공정거래위원회가 정하는
									『전자상거래 등에서의 소비자보호지침』 및
									관계법령 또는 상관례에 따릅니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 상품 또는 용역이 품절되거나 기술적
									사양의 변경 등으로 더 이상 제공할 수 없는
									경우에는 장차 체결되는 계약에 의해 제공할
									상품, 용역의 내용을 변경할 수 있습니다. 이
									경우에는 변경된 재화 또는 용역의 내용 및
									제공일자를 명시하여 현재의 재화 또는 용역의
									내용을 게시한 곳에 즉시 공지합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 컴퓨터 등 정보통신설비의 보수점검,
									교체 및 고장, 통신의 두절, 천재지변,
									불가항력, 기타 회사의 합리적인 통제범위를
									벗어난 사유가 발생한 경우에는 서비스의
								...
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 제1항의 사유로 서비스의 제공이
									일시적으로 중단됨으로 인하여 이용자 또는
									제3자가 입은 손해에 대하여 회사의 고의 또는
									과실이 없는 한 손해를 배상하지 아니합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									제 3장 서비스 이용계약
								...
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 회원가입 신청에 대한 승낙을 통해
									회원가입 절차를 완료하고 회사의 서비스 이용
									계정(이하 &quot;계정&quot;)을 부여합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사는 제1항에 따라 회원가입을 신청한 이용자
									중 다음 각 호에 해당하지 않는 한 회원으로
									등록합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									다만 제7조 제3항에 의한 회원자격 상실 후
									3년이 경과한 자로서 회사가 회원 재가입을
									승낙한 경우는 예외로 합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									② 등록 내용에 허위, 기재누락, 오기가 있는
									경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									변경사항을 회사에 통지하거나 수정하여야
									합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회원은 1인 당 1개의 계정만 가입할 수
									있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									대금, 기타 회사의 서비스 이용에 관련하여
									회원이 부담하는 채무를 기일에 지급하지 않는
									경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									③ 다른 사람의 회사의 서비스 이용을
									방해하거나 그 정보를 도용하는 등 전자상거래
									질서를 위협하는 경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									④ 회사를 이용하여 법령 또는 이 약관이
									금지하거나 공서양속에 반하는 행위를 하는
									경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회사가 회원 자격을 제한, 정지 시킨 후,
									동일한 행위가 2회 이상 반복되거나 30일
									이내에 그 사유가 시정 되지 아니하는 경우
									회사는 회원 자격을 상실시킬 수 있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									회원이 1년간 서비스를 이용하지 않아
									휴면회원으로 전환된 때로부터 다시 서비스를
									이용함이 없이 1년이 경과한 경우, 회사는
									서비스 이용계약을 해지하고 회원을 탈퇴
									처리할 수 있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									통지하고, 회원 등록 말소 전에 최소한 30일
									이상의 기간을 정하여 소명할 기회를
									부여합니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									본 조 제2항, 제3항 및 제5항의 규정에도
									불구하고, 다음의 각 호 중 어느 하나에
									해당하는 경우 회사는 그 사실을 알게 된
									날로부터 3 일 이내에 회원 및 이용자에게 그
									위반 사실을 통보한 후 회원자격을
									상실시키거나 회사의 서비스 이용을 영구히
									제한할 수 있습니다.
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<span className='md:w-[604px] text-xs text-left text-black'>
									...
									비정상적인 결제 를 하거나 기타 회사의
									시스템을 비정상적으로 이용하는 경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									④ 정당하지 않은 사유로 주문의 취소, 반품,
									환불 등을 반복하여 회사의 업무를 방해하는
									경우
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									⑤ 범죄 또는 현금화 목적 등으로 대금 결제
									방식을 악용하는 행위
								</span>
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
								...
								<br />
								<span className='md:w-[604px] text-xs text-left text-black'>
									⑦ 그 밖에 통상적이지 않은 방법으로 회사의
									업무와 다른 회원 및 이용자의 서비스 이용을
									방해하여 그 권리와 이익을 현저히 침해 하는
									경우
								</span>
							</p>
						}
