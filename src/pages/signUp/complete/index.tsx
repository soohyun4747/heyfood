...
function SignUpCompletePage() {
	...
	return (
		<Common meta={<Meta />}>
			<div className='flex flex-col justify-center items-center self-stretch gap-[60px] md:px-[120px] pt-[40px] md:pt-[100px] pb-[120px] md:pb-40 min-h-full'>
				...
				<div className='flex flex-col justify-start items-center gap-10'>
					<div className='flex flex-col justify-start items-center relative gap-6'>
						<p className='text-[24px] md:text-[32px] font-bold text-center text-[#0f0e0e]'>
							...
							<br />
							<span>
								헤이델리박스 회원이 되신 것을 <br className='md:hidden'/>환영합니다!
							</span>
						</p>
