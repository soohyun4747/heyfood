...
function LoginPage() {
	...
	return (
		<Common meta={<Meta />}>
			<div className='flex flex-col justify-center items-center self-stretch gap-[60px] px-[20px] md:px-[120px] pt-[40px] md:pt-[100px] pb-[120px] md:pb-40 bg-[#fffbea] md:min-h-[calc(100vh-112px)] min-h-[calc(100vh-70.4px)]'>
