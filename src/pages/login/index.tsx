...
function LoginPage() {
	...
	return (
		<Common meta={<Meta />}>
			<div className='flex flex-col justify-center items-center self-stretch gap-[60px] px-[20px] md:px-[120px] pt-[40px] md:pt-[100px] pb-[120px] md:pb-40 bg-[#fffbea] md:h-[calc(100vh-112px)] md:min-h-max'>
					...
					<div className='flex justify-start items-start self-stretch border-t-0 border-r-0 border-b border-l-0 border-[#d9d9d9]'>
						{['회원 로그인', '비회원 주문하기'].map((value, i) => (
							<div
								...
								<p className='md:text-xl text-center text-[#0f0e0e]'>
									{value}
								</p>
							</div>
						))}
