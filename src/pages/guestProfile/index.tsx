...
function GuestProfilePage() {
	...
	return (
		<Common meta={<Meta />}>
			<div className='flex flex-col justify-start items-center self-stretch gap-10 md:gap-[60px] md:px-[120px] pt-[40px] md:pt-[100px] pb-[120px] md:pb-40 min-h-fit h-screen'>
				...
				<div className='select-none flex justify-center items-start gap-8 self-stretch'>
