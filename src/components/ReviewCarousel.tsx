...
export const ReviewCarousel: React.FC = () => {
	...
	const reviews: Review[] = [
		...
		{
			id: '2',
			title: '맛, 가격, 비주얼 모두 갖춘 행사도시락은? 헤이푸드서비스',
			description:
		...
		},
		{
			...
			description:
				'직원들 후기가 너무 좋아서 다음 달 행사도 헤이푸드로 바로 예약했어요! 처음엔 반신반의했는데 식사 후 피드백이 정말 좋았어요. ‘요즘 먹은 도시락 중 제일 맛있다’는 말이 나올 정도였고, 앞으로 행사 도시락은 무조건 여기로 정했어요!!',
			author: 'U사 주*정 담당자님',
		},
	];
