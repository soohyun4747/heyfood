...
export function ModalCenter(props: IModalCenterProps) {
	return (
		<div className='fixed top-0 left-0 w-[100vw] h-[100vh] bg-black/40 flex items-center justify-center'>
			<div
				className='flex flex-col justify-start items-end flex-grow-0 flex-shrink-0 w-[490px] gap-12 p-12 rounded-3xl bg-white'
				...
				<div className='flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-6'>
					<div className='flex flex-col justify-center items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2 py-0.5'>
						<p className='flex-grow-0 flex-shrink-0 text-2xl font-bold text-center text-[#0f0e0e]'>
							{props.title}
						</p>
					</div>
					<div className='flex justify-center items-start self-stretch flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 text-lg text-center text-black'>
						{props.description}
					</div>
				</div>
