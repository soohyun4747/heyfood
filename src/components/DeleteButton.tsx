...
export function DeleteButton({ onClick }: { onClick?: () => void }) {
	...
	return (
		<div
			...
			<div className='group flex justify-start items-center w-[82px] relative gap-1 px-2.5 py-[3px]'>
				<Delete color={hover ? '#0F0E0E' : '#A0A0A0'} />
				<div className='flex justify-center items-center relative gap-2 pt-[3px]'>
					<p className='text-lg font-bold text-left text-[#a0a0a0] group-hover:text-[#0F0E0E]'>
						삭제
					</p>
				</div>
			</div>
